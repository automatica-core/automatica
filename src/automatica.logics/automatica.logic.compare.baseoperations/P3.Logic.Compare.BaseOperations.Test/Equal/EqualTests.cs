...
namespace P3.Logic.Compare.BaseOperations.Tests.Equal
{
    ...
    public class EqualTests: LogicTest<EqualLogicFactory>
    {
        ...
        public void TestEqualRule()
        {
            ...
            Logic.ValueChanged(GetLogicInterfaceByTemplate(EqualLogicFactory.RuleInput2), Dispatchable, 200);
        ...
        public void TestEqualRuleDateTime()
        {
           ...
           Logic.ValueChanged(GetLogicInterfaceByTemplate(EqualLogicFactory.RuleInput2), Dispatchable, new DateTime(2024, 03, 31));
            Assert.True(Logic.ValueChanged(GetLogicInterfaceByTemplate(EqualLogicFactory.RuleInput1), Dispatchable, new DateTime(2024, 03, 31))[0].ValueBoolean);
         }
        ...
        public void TestEqualRuleDateOnly()
        {
            ...
            Assert.True(Logic.ValueChanged(GetLogicInterfaceByTemplate(EqualLogicFactory.RuleInput1), Dispatchable, new DateOnly(2022, 03, 31))[0].ValueBoolean);
       }
        [Fact]
        public void TestEqualRuleTimeOnly()
        {
            ...
            Assert.True(Logic.ValueChanged(GetLogicInterfaceByTemplate(EqualLogicFactory.RuleInput1), Dispatchable, new TimeOnly(22, 03, 31))[0].ValueBoolean);
        }
    }
}
