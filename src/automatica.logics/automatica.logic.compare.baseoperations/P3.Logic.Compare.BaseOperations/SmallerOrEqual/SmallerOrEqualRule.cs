...
{
    public class SmallerOrEqualRule : Automatica.Core.Logic.Logic
    {
        ...
        public SmallerOrEqualRule(ILogicContext context) : base(context)
        {
            _output = context.RuleInstance.RuleInterfaceInstance.SingleOrDefault(a =>
                a.This2RuleInterfaceTemplate == SmallerOrEqualLogicFactory.RuleOutput);
        }
