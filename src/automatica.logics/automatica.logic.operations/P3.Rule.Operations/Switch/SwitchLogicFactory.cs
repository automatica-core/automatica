...
namespace P3.Rule.Operations.Switch
{
    public class SwitchLogicFactory : RuleFactory
    {
        ...
        public static Guid RuleTimerParameter = new Guid("4809f06b-bd0e-4723-baef-6a89790716e7");
        ...
        public override void InitTemplates(IRuleTemplateFactory factory)
        {
            ...
            factory.CreateRuleInterfaceTemplate(RuleInput, "OPERATIONS.SWITCH.INPUT.NAME", "OPERATIONS.SWITCH.INPUT.DESCRIPTION", RuleGuid, RuleInterfaceDirection.Input, 0, 1);
            factory.CreateRuleInterfaceTemplate(RuleState, "OPERATIONS.SWITCH.STATE.NAME", "OPERATIONS.SWITCH.STATE.DESCRIPTION", RuleGuid, RuleInterfaceDirection.Input, 0, 2);

            factory.CreateRuleInterfaceTemplate(RuleOutput, "OPERATIONS.SWITCH.OUTPUT.NAME", "OPERATIONS.SWITCH.OUTPUT.DESCRIPTION", RuleGuid, RuleInterfaceDirection.Output, 0, 1);
