...
namespace P3.Driver.HueBridge.Api
{
    ...
    /// </summary>
    public abstract class PublisherBase : DisposableManagedObjectBase, ISsdpDevicePublisher
    {
        ...
        private readonly IEnumerable<SsdpRootDevice> _ReadOnlyDevices;
...
{0}
ST: {1}
SERVER: {4}/{5} UPnP/1.0 IpBridge/1.19.0{6}
USN: {2}
LOCATION: {3}{8}
...
";
        ...
        protected PublisherBase(ISsdpCommunicationsServer communicationsServer, string osName, string osVersion) : this(communicationsServer, osName, osVersion, NullLogger.Instance)
        {
        }
        ...
        protected PublisherBase(ISsdpCommunicationsServer communicationsServer, string osName, string osVersion, ISsdpLogger log)
        {
            ...
            _ReadOnlyDevices = new List<SsdpRootDevice>(_Devices);
        ...
        private IEnumerable<SsdpDevice> GetDevicesMatchingSearchTarget(string searchTarget, IEnumerable<SsdpDevice> devices)
        {
            lock (_Devices)
            {
                if (String.Compare("ssdp:all", searchTarget, StringComparison.OrdinalIgnoreCase) == 0)
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void SendDeviceSearchResponses(SsdpDevice device, string searchTarget, UdpEndPoint endPoint)
        {
            ...
            bool sendAll = searchTarget == "ssdp:all";
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void CommsServer_RequestReceived(object sender, RequestReceivedEventArgs e)
        {
            ...
            if (e.Message.Method.Method == "M-SEARCH")
            {
