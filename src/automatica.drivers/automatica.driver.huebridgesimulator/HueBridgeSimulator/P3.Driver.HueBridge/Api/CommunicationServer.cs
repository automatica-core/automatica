...
{
    /// </summary>
	public sealed class CommunicationsServer : DisposableManagedObjectBase, ISsdpCommunicationsServer
    {
		...
		*/
        ...
        public int UdpSendCount { get; set; } = 5;
