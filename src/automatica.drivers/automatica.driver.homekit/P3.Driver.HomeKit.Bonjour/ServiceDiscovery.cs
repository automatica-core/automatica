...
using P3.Driver.HomeKit.Bonjour.Abstraction.Resolving;
...
namespace P3.Driver.HomeKit.Bonjour
{
    ...
    public class ServiceDiscovery : IDisposable
    {
        ...
        /// </param>
        public ServiceDiscovery(ILogger logger, MulticastService mdns)
        {
            this._logger = logger;
            this.Mdns = mdns;
        ...
        public void Advertise(ServiceProfile service)
        {
            ...
            catalog.Add(new PTRRecord { Name = ServiceName, DomainName = service.QualifiedServiceName }, true);
            catalog.Add(new PTRRecord { Name = service.QualifiedServiceName, DomainName = service.FullyQualifiedName }, true);
        ...
        {
            _profiles.ForEach(profile => UnAdvertise(profile));
        }
        ...
        void OnAnswer(object sender, MessageEventArgs e)
        {
            ...
            _logger.LogDebug($"Answer from {e.RemoteEndPoint}");
        ...
        void OnQuery(object sender, MessageEventArgs e)
        {
            ...
            _logger.LogDebug($"Query from {e.RemoteEndPoint}");
