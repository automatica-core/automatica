    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var homekit = new HomeKitServer(logger, 54321, "AAAAA", ltsk, ltpk, homekitId,
                code, "demo", homekitId, 7, "0.0.1");

            homekit.PairingCompleted += Homekit_PairingCompleted;

            var lightAccessory = AccessoryFactory.CreateLightBulbAccessory(2, "Light1", "AutomaticaCore", "123456", true);
            var lightAccessory2 = AccessoryFactory.CreateLightBulbAccessory(3, "Light2", "AutomaticaCore", "12345", false);
            var lightAccessory3 = AccessoryFactory.CreateLightBulbAccessory(4, "Light3", "AutomaticaCore", "1234567", false);
            ...
            var lightAccessory4 = AccessoryFactory.CreateLightBulbAccessory(10, "Light4", "AutomaticaCore", "asdf1234567", false);
