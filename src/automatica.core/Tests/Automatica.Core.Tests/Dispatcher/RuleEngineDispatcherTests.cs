...
namespace Automatica.Core.Tests.Dispatcher
{
    public class RuleEngineDispatcherTests : BaseDispatcherTest
    {
        ...
        [Fact]
        public async Task TestNode2NodeDispatch_TargetInverted()
        {
            var source = await DispatcherHelperUtils.CreateNodeMock(Guid.NewGuid(), "Source", Dispatcher,
                NodeInstanceCache, DriverNodesStore);
            var target = await DispatcherHelperUtils.CreateNodeMock(Guid.NewGuid(), "Target", Dispatcher,
            ...
            CreateLink(a =>
            {
                a.This2NodeInstance2RulePageInputNavigation = CreateLogicNodeInstance(a =>
                {
                    a.This2NodeInstance = target.Children[0].DriverContext.NodeInstance.ObjId;
                    a.Inverted = true;
                });
                a.This2NodeInstance2RulePageOutputNavigation = new NodeInstance2RulePage
                {
            ...
            Assert.True(((DriverNodeMock)target.Children[0]).WriteReceived);
            var value = Dispatcher.GetValue(DispatchableType.NodeInstance, target.Children[0].Id);
        ...
        public async Task TestNode2RuleDispatch()
        {
            ...
            var value = Dispatcher.GetValue(DispatchableType.RuleInstance, target.Output.ObjId);
        ...
        [Fact]
        public async Task TestNode2RuleDispatchWithInvertedOutput()
        {
            var source = await DispatcherHelperUtils.CreateNodeMock(Guid.NewGuid(), "Source", Dispatcher,
                NodeInstanceCache, DriverNodesStore);
            var target = await DispatcherHelperUtils.CreateLogicMock("Target", Dispatcher, null,
            ...
            var ruleOutputTarget = await DispatcherHelperUtils.CreateNodeMock(Guid.NewGuid(), "test", Dispatcher,
                NodeInstanceCache, DriverNodesStore);
            var targetOutputInterface = target.Context.RuleInstance.RuleInterfaceInstance
            ...
            CreateLink(a =>
            {
                a.This2NodeInstance2RulePageInputNavigation = new NodeInstance2RulePage
                {
                    This2NodeInstance = ruleOutputTarget.Children[0].Id
                };
                a.This2RuleInterfaceInstanceOutputNavigation = new RuleInterfaceInstance()
                {
                    This2RuleInstance = targetOutputInterface.ObjId
                };
                a.This2RuleInterfaceInstanceOutput = targetOutputInterface.ObjId;
            });

            await LogicEngineDispatcher.Load();

            target.Output.Inverted = true;
        ...
        public async Task TestRule2NodeDispatch_TargetInverted()
        {
            ...
            CreateLink(a =>
            {
                a.This2NodeInstance2RulePageInputNavigation = CreateLogicNodeInstance(a =>
                {
                    a.This2NodeInstance = target.Children[0].Id;
                    a.Inverted = true;
                });
                a.This2RuleInterfaceInstanceOutputNavigation = new RuleInterfaceInstance()
                {
