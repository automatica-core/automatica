...
namespace Automatica.Core.EF.Migrations
{
    ...
    [Migration("20181110142529_AddedPluginGuidToPluginTable")]
    partial class AddedPluginGuidToPluginTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.Priviledge", b =>
                {
                    b.Property<Guid>("ObjId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.Priviledge2Role", b =>
                {
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.Role", b =>
                {
                    b.Property<Guid>("ObjId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.User", b =>
                {
                    b.Property<Guid>("ObjId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.User2Group", b =>
                {
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.User2Role", b =>
                {
                    b.Property<Guid>("This2User");
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.UserGroup", b =>
                {
                    b.Property<Guid>("ObjId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.UserGroup2Role", b =>
                {
                    b.Property<Guid>("This2UserGroup");
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.Areas.AreaInstance", b =>
                {
                    ...
                    b.HasOne("Automatica.Core.EF.Models.User.UserGroup", "This2UserGroupNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.Priviledge2Role", b =>
                {
                    b.HasOne("Automatica.Core.EF.Models.User.Priviledge", "This2PriviledgeNavigation")
                        .WithMany("InverseThis2Roles")
                        .HasForeignKey("This2Priviledge")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Automatica.Core.EF.Models.User.Role", "This2RoleNavigation")
            ...
            modelBuilder.Entity("Automatica.Core.EF.Models.User.User2Group", b =>
                {
                    b.HasOne("Automatica.Core.EF.Models.User.User", "This2UserNavigation")
