...
export class SidebarToggleDirective implements OnDestroy {
  ...
  @Input()
  toggleClass: string = "sidebar-hidden";
  ...
  toggleOpen($event: any) {
    ...
    document.querySelector("body").classList.toggle(this.toggleClass);
  }

  ngOnDestroy(): void {
    document.querySelector("body").classList.remove(this.toggleClass);
  }

}

@Directive({
  selector: "[mobileSidebarToggleDirective]"
})
